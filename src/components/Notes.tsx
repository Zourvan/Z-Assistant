      ...
      <form onSubmit={addNote} className="mb-2">
        <div className="flex gap-1 mb-1 items-start">
          ...
          <div className="flex flex-col gap-2">
            <button
              type="submit"
              className="flex items-center justify-center w-8 h-8 bg-white/20 hover:bg-white/30 text-white rounded-lg transition-colors"
            >
            ...
            {editingNoteId === note.id ? (
              <>
                <textarea
                  ...
                  className={`w-full bg-white/20 text-white placeholder-white/50 rounded-lg px-3 py-1.5 min-h-[60px] focus:outline-none focus:ring-2 focus:ring-white/30 ${
                ...
                <div className="mt-2 flex justify-center gap-2 items-center">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-8 h-8 bg-white/20 hover:bg-white/30 text-white rounded transition-all"
                  >
