/** Exact DOM from “Charles the CSS Corgi” (CodePen aNmoYR by JayJay89). */
export const CHARLES_CORGI_HTML = `
  <div class="charles-corgi">
    <div class="head">
...
export const CHARLES_CORGI_WIDTH = 42;
export const CHARLES_CORGI_HEIGHT = 30;
